...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="catUploadForm">
                @csrf
                <div class="card">
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <input type="text" name="hsn" id="hsn" class="form-control"
                                    value="{{ old('hsn') }}" placeholder="HSN" required>
                            </div>
                        </div>
                        <div class="form-group row  mb-2">
                            <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
                                ...
                                <select name="pack_size" id="pack_size" class="form-control" required>
                                    ...
                                    @foreach ($packSizes as $pack)
                                        <option value="{{ $pack->id }}"
                                            {{ old('pack_size') == $pack->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <input type="text" name="cost_price" id="cost_price" class="form-control"
                                    value="{{ old('cost_price') }}" placeholder="Cost price" required>
                            </div>
                        </div>
                        <div class="form-group row  mb-2">
                            <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
